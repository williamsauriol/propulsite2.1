          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-6">
                <div className="aspect-square bubble-glass overflow-hidden">
                  <img src="https://picsum.photos/seed/builder/400/400" alt="Construction Builder" className="w-full h-full object-cover opacity-60" referrerPolicy="no-referrer" />
                </div>
                <div className="aspect-[3/4] bubble-glass overflow-hidden">
                  <img src="https://picsum.photos/seed/blueprint/400/533" alt="Digital Blueprint" className="w-full h-full object-cover opacity-60" referrerPolicy="no-referrer" />
                </div>
              </div>
              <div className="space-y-6 pt-12">
                <div className="aspect-[3/4] bubble-glass overflow-hidden">
                  <img src="https://picsum.photos/seed/excavator/400/533" alt="Excavator Work" className="w-full h-full object-cover opacity-60" referrerPolicy="no-referrer" />
                </div>
                <div className="aspect-square bubble-glass overflow-hidden">
                  <img src="https://picsum.photos/seed/marketing-data/400/400" alt="Marketing Analytics" className="w-full h-full object-cover opacity-60" referrerPolicy="no-referrer" />
                </div>
              </div>
            </div>
          </div>
