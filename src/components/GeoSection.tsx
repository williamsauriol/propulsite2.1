    ...
    <section className="px-4 md:px-6 mt-32 md:mt-52 mb-12 md:mb-20">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-black leading-[0.95] text-white uppercase tracking-tight mb-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
          ...
          >
            <ul className="space-y-5 mb-10">
              {BENEFITS.map((b) => (
                <li key={b} className="flex items-start gap-4 text-white/85 text-lg">
                  <span className="flex-shrink-0 w-7 h-7 rounded-full bg-accent-blue/15 border border-accent-blue/40 flex items-center justify-center text-accent-blue mt-0.5">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                ...
                className="inline-flex items-center gap-2 px-9 py-5 bg-accent-blue rounded-full text-[#050a15] font-black uppercase tracking-widest text-sm hover:bg-white transition-all duration-300 shadow-[0_0_25px_rgba(0,210,255,0.6)] hover:shadow-[0_0_35px_rgba(255,255,255,0.7)] transform hover:-translate-y-1"
              >
                Découvrir le GEO <ArrowRight className="w-4 h-4" />
              </Link>
              <Link
                to="/blog/geo-chatgpt-construction"
                className="inline-flex items-center px-9 py-5 bubble-glass text-white/80 font-bold uppercase tracking-widest text-sm hover:text-white"
              >
                Lire l'article
              </Link>
            </div>
          ...
          >
            <div className="relative bg-[#0a1628]/90 backdrop-blur-md border border-accent-blue/30 rounded-3xl p-6 md:p-8 shadow-[0_25px_70px_rgba(0,210,255,0.18)]">
              {/* Liseré lumineux */}
              ...
              <div className="flex items-center gap-3 pb-5 border-b border-white/10 mb-6">
                <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-accent-blue to-cyan-300 flex items-center justify-center text-[#050a15]">
              ...
              <div className="flex justify-end mb-5">
                <div className="bg-accent-blue/15 border border-accent-blue/25 text-white/90 rounded-2xl rounded-tr-sm px-4 py-3 max-w-[80%] text-[15px] leading-relaxed">
              ...
              <div className="flex justify-start">
                <div className="bg-white/5 border border-white/10 text-white/85 rounded-2xl rounded-tl-sm px-4 py-3 max-w-[90%] text-[15px] leading-relaxed min-h-[110px]">
                  {started ? (
                    <>
                      {renderTyped(count)}
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {WHY_NOW.map((c) => (
              <div
                key={c.title}
                className="bg-white/[0.03] border border-white/10 rounded-2xl p-7 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-accent-blue/40 hover:shadow-[0_15px_45px_rgba(0,210,255,0.12)]"
              >
                <div className="w-12 h-12 rounded-xl bg-accent-blue/15 border border-accent-blue/30 flex items-center justify-center text-accent-blue mb-5">
                  {c.icon}
                </div>
